...
const RESPONSE = {
    'issues': [{ 
            'flags': [], 'name': 'Unnecessarily Gendered Words', 'summary': '' 
        }, { 
            'flags': [], 'name': 'Personal Life', 'summary': '' 
        }, {
            'flags': [
            ...
            'flags': [], 'name': '\nTerms biased towards women', 'summary': '' }, { 
            'flags': [], 'name': '\nTerms biased towards men:', 'summary': '' }, { 
            'flags': [], 'name': 'Conditional Superlatives', 'summary': '' }],
